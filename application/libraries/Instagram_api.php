...
class Instagram_api {
    ...
    function instagramFbLogin() {
    
        return 'https://api.instagram.com/oauth/authorize/?client_id=' . $this->codeigniter_instance->config->item('instagram_client_id') . '&redirect_uri=' . $this->codeigniter_instance->config->item('instagram_callback_urls') . '&response_type=code';
    
    }
    function instagramMLogin() {
        return 'https://api.instagram.com/oauth/authorize/?client_id=' . $this->codeigniter_instance->config->item('instagram_client_id') . '&redirect_uri=' . $this->codeigniter_instance->config->item('instagram_callback_urlss') . '&response_type=code';
