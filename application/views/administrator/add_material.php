        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    ...
                    <?=form_open_multipart('administrator/add_material',array('class' => 'form-horizontal', 'id' => 'myform'));?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="" name="mat_name" value="<?=set_value('mat_name')?>"/>
                            </div>
