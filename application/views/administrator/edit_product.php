        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body" style="padding:15px 0 0 0">
                    <form action="<?=base_url()?>administrator/ajax_upload1" class=form-horizontal enctype="multipart/form-data" method="post" accept-charset="utf-8" id="imageform1">
                        <div class="form-group">
                           ...
                           <div class="col-md-3"><div class="upload-photo1"><img src="<?=base_url()?>uploads/products/<?=$result->image?>" class="img-responsive"></div></div>
                        </div>
                    </form>
                </div>
                ...
                <div class="panel-body" style="padding:0">
                    <form action="<?=base_url()?>administrator/ajax_upload2" class=form-horizontal enctype="multipart/form-data" method="post" accept-charset="utf-8" id="imageform2">
                        <div class="form-group">
                           ...
                           <div class="col-md-3"><div class="upload-photo2"><a href="<?=base_url()?>uploads/products/<?=$result->prod_pdf1?>"><?=$result->prod_pdf1?></a></div></div>
                        </div>
                    </form>
                </div>
                ...
                <div class="panel-body" style="padding:0">
                    <form action="<?=base_url()?>administrator/ajax_upload3" class=form-horizontal enctype="multipart/form-data" method="post" accept-charset="utf-8" id="imageform3">
                        <div class="form-group">
                           ...
                           <div class="col-md-3"><div class="upload-photo3"><a href="<?=base_url()?>uploads/products/<?=$result->prod_pdf2?>"><?=$result->prod_pdf2?></a></div></div>
                        </div>
                    </form>
                </div>
                ...
                <div class="panel-body" style="padding:0">
                    ...
                    <?=form_open_multipart('administrator/edit_product/'.$result->prod_id,array('class' => 'form-horizontal', 'id' => 'myform'));?>

                        <div class="upload-photo1"><input type="hidden" name="image" value="<?=@$result->image?>"></div>
                        <div class="upload-photo2"><input type="hidden" name="prod_pdf1" value="<?=@$result->prod_pdf1?>"></div>
                        <div class="upload-photo3"><input type="hidden" name="prod_pdf2" value="<?=@$result->prod_pdf2?>"></div>

                        <div class="form-group">
                            <label class="col-md-3 control-label">Name</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control title" placeholder="" name="prod_name" value="<?=$result->prod_name?>"/>
                            </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <?=form_dropdown('cat_id', $categories, $result->cat_id, ' id="category" class="form-control"');?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                               <select name="sub_id" id="subcategory" class="form-control">
                                   ...
                                   <option value="<?=$result->sub_id?>" selected><?=$result->sub_name?></option>
                               </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea name="description" id="" class="form-control ckeditor"><?=$result->description?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea name="uses" id="" class="form-control ckeditor"><?=$result->uses?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea name="availability" id="" class="form-control ckeditor"><?=$result->availability?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea name="tips" id="" class="form-control ckeditor"><?=$result->tips?></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea name="features" id="" class="form-control ckeditor"><?=$result->features?></textarea>
                            </div>
