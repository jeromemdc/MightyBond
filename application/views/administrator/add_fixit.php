        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    ...
                    <?=form_open('administrator/add_fixit','class=form-horizontal');?>

                        <div class="form-group">
                            <label class="col-md-3 control-label">Product</label>
                            <div class="col-md-6">
                                <?=form_dropdown('product_id', $products, set_value('product_id'), ' class="form-control"');?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <?=form_dropdown('material', $materials, set_value('material'), ' id="category" class="form-control"');?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="" name="external_factor" value="<?=set_value('external_factor')?>"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="" name="fix_type" value="<?=set_value('fix_type')?>"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea name="remarks" class="form-control ckeditor"><?=set_value('remarks')?></textarea>
                            </div>
