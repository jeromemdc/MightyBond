        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                ...
                <div class="panel-body">
                    ...
                    <?=form_open('administrator/edit_subcategory/'.$result->sub_id,'class=form-horizontal');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" placeholder="" name="sub_name" value="<?=$result->sub_name?>"/>
                            </div>
